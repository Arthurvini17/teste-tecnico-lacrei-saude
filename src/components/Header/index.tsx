        ...
        <header className="w-full bg-transparent">
            <nav className="flex items-center justify-between h-16 px-6 md:px-12 relative">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <button className="px-4 py-1 border shadow-sm border-[#018762] text-[#018762] font-semibold rounded-md hover:bg-[#018762] hover:text-white transition-colors">
                        Entrar
                    </button>
                    <button className="px-4 py-1 border border-[#018762] text-[#018762] font-semibold rounded-md hover:bg-[#018762] hover:text-white transition-colors">
                        Cadastrar
                    </button>
                </div>
