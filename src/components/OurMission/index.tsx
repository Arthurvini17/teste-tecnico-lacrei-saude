...
export default function OurMission() {
    return (
        ...
        <section className="mt-20 sm:flex sm:items-center sm:justify-center sm:text-center sm:flex-col">
            <div>
            ...
            <div>
                <h1 className="font-semibold">Nossos valores</h1>
            </div>

            <div className="sm:flex sm:flex-row  flex flex-col items-center gap-10 mt-10 p-20  ">
